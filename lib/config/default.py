...
_C.DATASET.DATAROOT = '/workspace/YOLOP/dataset/images/'                  # the path of images folder
_C.DATASET.LABELROOT = '/workspace/YOLOP/dataset/det_annotations'         # the path of det_annotations folder
_C.DATASET.MASKROOT = '/workspace/YOLOP/dataset/da_seg_annotations'       # the path of da_seg_annotations folder
_C.DATASET.LANEROOT = '/workspace/YOLOP/dataset/ll_seg_annotations'       # the path of ll_seg_annotations folder
